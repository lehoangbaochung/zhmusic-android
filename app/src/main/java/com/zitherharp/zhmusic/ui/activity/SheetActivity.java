...
public class SheetActivity extends Activity implements EasyPermissions.PermissionCallbacks {
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            String spreadsheetId = "1ICOivODkrc4A86I1JVEQ0sVEa-8XriKoG5O4116xiKo";
            String range = "Vietnamese!A2:E";
